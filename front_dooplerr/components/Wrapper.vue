<template>
    <div class="relative wrapper-container">
        ...
        <!-- <div v-if="!isAtStart" :class="{ 'active': !isAtStart }"
        ...
        <div class="absolute arrow right-2 top-0 bottom-0 flex items-center justify-center z-50">
...
const displayClasses = {
    ...
    list: "flex flex-col gap-6 container mx-auto",
